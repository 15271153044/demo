...
import com.ywb.comm.utils.excel.ExcelUtils;
import lombok.Data;
...
public class ExcelControllerTests {
    ...
    public void readLessThan1000Row(){
        String filePath = "C:\\Users\\ywb\\Desktop\\zhjy.xlsx";
    ...
    public void readLessThan1000RowBySheet(){
        ...
        List<Object> objects = ExcelUtils.readLessThan1000RowBySheet(filePath,sheet);
        objects.forEach(System.out::println);
    }
    ...
    public void writeBySimple(){
        ...
        ExcelUtils.writeBySimple(filePath,data,head);
    }
    ...
    public void writeWithMultipleSheel(){
        ArrayList<ExcelUtils.MultipleSheelPropety> list1 = new ArrayList<>();
        for(int j = 1; j < 4; j++){
            ...
            ExcelUtils.MultipleSheelPropety multipleSheelPropety = new ExcelUtils.MultipleSheelPropety();
        ...
        ExcelUtils.writeWithMultipleSheel("/home/chenmingjian/Downloads/aaa.xlsx",list1);
